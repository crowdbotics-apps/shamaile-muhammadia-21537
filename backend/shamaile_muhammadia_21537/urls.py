"""shamaile_muhammadia_21537 URL Configuration
...
admin.site.site_header = "Shamaile Muhammadia"
admin.site.site_title = "Shamaile Muhammadia Admin Portal"
admin.site.index_title = "Shamaile Muhammadia Admin"

# swagger
api_info = openapi.Info(
    title="Shamaile Muhammadia API",
    default_version="v1",
    description="API documentation for Shamaile Muhammadia App",
)
